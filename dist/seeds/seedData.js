...
const connectDB = async () => {
    try {
        await mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb+srv://nurudeeny17:Rich4ever@cluster0.gkcwpna.mongodb.net/udehglobal');
...
const seedDatabase = async () => {
    try {
        ...
        await User_1.User.deleteMany({ role: 'admin' });
        ...
        await Product_1.Product.insertMany(productsData);
        console.log('🌱 Creating admin user...');
        await User_1.User.create(adminUserData);
